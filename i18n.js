...
const i18n = Object.freeze({
	DE: Object.freeze({
		...
		tutorial: {
			...
			turns: 'Wähle, wie lang das Spiel dauern soll. Für den Anfang sollte fünf runden ausreichen.',
			wm_units: 'Setze deine Einheiten auf die Weltkarte. Nach der ersten Einheit kannst du weitere Einheiten nur direkt neben schon platzierte Einheiten setzen. Pass auf, dich nicht an der Küste oder in den Bergen einzubauen.',
		},
	...
	EN: Object.freeze({
		...
		tutorial: {
			...
			wm_units: 'Place your units on the world map. After the first unit, you can only place units adjacent to others. So take care to not trap yourself close to the coast or in the mountains.',
		},
