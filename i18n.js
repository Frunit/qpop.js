...
const i18n = Object.freeze({
	DE: Object.freeze({
		...
		tutorial: {
			...
			mutation_start: 'Benutze Mutationspunkte um die Eigenschaften der Spezies zu verbessern. Zu Beginn hast du 100 Mutationspunkte, später wird die Anzahl von deinen Erfolgen im Spiel abhängen. Die Kreise rechts zeigen an, welche Pflanzen die Spezies auf der Weltkarte besetzt.',
	...
	EN: Object.freeze({
		...
		tutorial: {
			...
			mutation_start: 'Distribute mutation points to improve traits of your species. In the beginning, you have 100 mutation points but later in the game, the number will depend on your success in the game. The circles to the right show, which plants your species occupies on the world map.',
