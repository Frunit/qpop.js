...
export class Loader {
	...
	finished_loading(self) {
		...
		resources.load([
			['sfx/catastrophe', 'audio', 'catastrophe'],
			['sfx/outro', 'audio', 'outro'],
			['anim_gfx/amoegro.png', 'image'],
