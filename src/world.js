...
export class World {
	...
	volcano_step(volcanos_left, positions) {
		if (volcanos_left === 0) {
			this.catastrophe_finish();
			return;
		}
	...
	draw_wm_part(x, y, show_spec = true, shadow = false) {
		let tile = 0;
		if (game.world_map[y][x] === WORLD_MAP.WATER) {
